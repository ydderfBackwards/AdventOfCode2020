namespace AdventOfCode2020.Inputs
{
    class Day07
    {
        ...
        public string testInput = @"light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags.";
        ...
        public string input = @"wavy bronze bags contain 5 striped gold bags, 5 light tomato bags.
