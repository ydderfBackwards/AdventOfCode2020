...
namespace AdventOfCode2020
{
    public class Day22_Hashset
    {
        ...
        public (int, int) PlayRecursiveCombat(List<int> deckP1, List<int> deckP2)
        {
            ...
            HashSet<string> playedDeckP1 = new HashSet<string>(); //Changed to Hashset instead of List for better performance (thanks to Tweakers.net user: DRaakje)
            HashSet<string> playedDeckP2 = new HashSet<string>();
